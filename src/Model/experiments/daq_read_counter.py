...
######################################################
# class below is yet to be fully implemented and tested
#############################################################

# class Daq_Read_Counter_2_Channel(Experiment):
#     """
# This experiment reads the Counter input from the DAQ and plots it.
#
...
#     ]
#
#     _DEVICES = {'daq': PXI6733,  'microwave_generator': MicrowaveGenerator, 'piezo_controller': PiezoController}
#
...
#                 self.last_value_b = 0
#
#             # Experiment crashes after about 500 loops if the sampling rate is set to 1 kS/s
