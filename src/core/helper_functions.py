...
def module_name_from_path(folder_name, verbose=False):
    ...
    the module is idenitified by
        ...
        then folder_name = '/Users/PycharmProjects/AQuISS/src/scripts/script_dummy.pyc'
        returns '/Users/PycharmProjects/' as the path and AQuISS.src.script_dummy as the module

    Args:
        folder_name: path to a file of the form
        '/Users/PycharmProjects/AQuISS/AQuISS/scripts/script_dummy.pyc'

    Returns:
        module: a string of the form, e.g. AQuISS.scripts.script_dummy ...
    ...
    # module = module[:-1]
    # print('mod', module)
    # from the list construct the path like AQuISS.scripts and load it
    module.reverse()
    module = '.'.join(module)
