...
Script.
    ...
    def create_dynamic_script_class(script_information, script_iterators={},verbose=False):
        ...
        Poststate: Dynamically created classes inheriting from ScriptIterator are added to AQuISS.scripts
            ...
            if isinstance(script_information, dict):
                ...
                for sub_script_name, sub_script_class in script_sub_scripts.items():
                    if isinstance(sub_script_class, Script):
                        ...
                        script_iterator_module = __import__('src.core.script_iterator')
        ...
        def create_script_iterator_class(sub_scripts, script_settings, script_iterator_base_class, verbose=verbose):
            ...
            dynamic_class = type(class_name, (script_iterator_base_class,), {'_SCRIPTS': sub_scripts, '_DEFAULT_SETTINGS': script_settings, '_DEVICES': {}})
            ...
            # Now we place the dynamic script into the scope of AQuISS.
        ...
        for p in packs:
            for name, c in inspect.getmembers(importlib.import_module(p), inspect.isclass):
                ...
                if issubclass(c, ScriptIterator):
                    # update dictionary with 'Package name , e.g. AQuISS or b103_toolkit': <ScriptIterator_class>
