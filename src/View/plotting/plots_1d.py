...
from src.Model.data_processing.fit_functions import lorentzian, double_lorentzian
...
def plot_esr(axes, frequency, counts, fit_params=None, plot_marker_data = 'b', plot_marker_fit = 'r', linestyle = '-', marker = '.'):
    ...
    #  ======== plot data =========
    axes.clear() # GD 20230803 - matplotlib axes.hold() removed in update to 3.0.0
