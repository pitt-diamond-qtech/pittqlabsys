...
' Includes overhead factor calibration for precise timing.
' Clean production version without debug parameters.
...
Init:
  ...
  ' Watchdog (production): 5 s (units = 10 µs) - increased for longer dwell times
